...
//#endregion
//#region node_modules/highs/build/highs.js
var require_highs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Module = (() => {
		...
		return (function(moduleArg = {}) {
			...
			if (m) {
				var fs = require_browser_external_fs(), ja = require_browser_external_path();
				v = __dirname + "/";
				w = (a) => {
			...
			} else if (ca || da) da ? v = self.location.href : "undefined" != typeof document && document.currentScript && (v = document.currentScript.src), _scriptName && (v = _scriptName), v = v.startsWith("blob:") ? "" : v.substr(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), da && (w = (a) => {
			...
			var oa = g.wasmBinary, pa, qa = !1, ra, y, z, sa, A, B;
			function ta() {
				var a = pa.buffer;
			...
			function Ca(a) {
				if (a == Ba && oa) return new Uint8Array(oa);
				if (w) return w(a);
			...
			var La = 0, Ma = 0, G = () => {
				...
				if (m) try {
					var a = require_browser_external_crypto();
			...
			var Za = {
				...
				read(a, b, c, d) {
					if (!a.tty || !a.tty.V.ma) throw new K(60);
				...
				write(a, b, c, d) {
					if (!a.tty || !a.tty.V.ga) throw new K(60);
					try {
						for (var e = 0; e < d; e++) a.tty.V.ga(a.tty, b[c + e]);
					} catch (f) {
						throw new K(29);
					}
			...
			var M = {
				...
				N: {
					...
					T(a, b) {
						...
						if (void 0 !== b.size && (b = b.size, a.R != b)) if (0 == b) a.O = null, a.R = 0;
						else {
							var c = a.O;
							a.O = new Uint8Array(b);
							c && a.O.set(c.subarray(0, Math.min(b, a.R)));
							a.R = b;
						}
					},
					lookup() {
					...
					rename(a, b, c) {
						if (16384 === (a.mode & 61440)) {
							...
							if (d) for (var e in d.O) throw new K(55);
						}
					...
					rmdir(a, b) {
						var c = fb(a, b), d;
						for (d in c.O) throw new K(55);
						delete a.O[b];
						a.timestamp = Date.now();
					},
					readdir(a) {
						var b = [".", ".."], c;
						for (c of Object.keys(a.O)) b.push(c);
						return b;
					},
					symlink(a, b, c) {
				...
				P: {
					...
					write(a, b, c, d, e, f) {
						...
						if (b.subarray && (!a.O || a.O.subarray)) {
							if (f) return a.O = b.subarray(c, c + d), a.R = d;
							if (0 === a.R && 0 === e) return a.O = b.slice(c, c + d), a.R = d;
							if (e + d <= a.R) return a.O.set(b.subarray(c, c + d), e), d;
						}
						bb(a, e + d);
						if (a.O.subarray && b.subarray) a.O.set(b.subarray(c, c + d), e);
						else for (f = 0; f < d; f++) a.O[e + f] = b[c + f];
				...
				b && (c |= 146);
				return c;
			}, hb = null, ib = {}, N = [], jb = 1, O = null, kb = !1, lb = !0, K = class {
				name = "ErrnoError";
				constructor(a) {
					this.X = a;
				}
			...
			function P(a, b = {}) {
				...
				for (var c = hb, d = "/", e = 0; e < a.length; e++) {
					...
					c.$ && (!f || f && b.la) && (c = c.$.root);
					if (!f || b.ka) {
						for (f = 0; 40960 === (c.mode & 61440);) if (c = pb(d), d = Sa(Oa(d), c), c = P(d, { ha: b.ha + 1 }).node, 40 < f++) throw new K(32);
					}
				}
				return {
					path: d,
			...
			function qb(a) {
				for (var b;;) {
					if (a === a.parent) return a = a.U.pa, b ? "/" !== a[a.length - 1] ? `${a}/${b}` : a + b : a;
					b = b ? `${a.name}/${b}` : a.name;
					a = a.parent;
				}
			}
			...
			function vb(a, b = -1) {
				...
				if (-1 == b) a: {
					for (b = 0; 4096 >= b; b++) if (!N[b]) break a;
					throw new K(33);
				}
				a.fd = b;
				return N[b] = a;
			...
			function xb(a, b) {
				var c = "/" === b;
				if (c && hb) throw new K(10);
				if (!c && b) {
					var d = P(b, { la: !1 });
					b = d.path;
					d = d.node;
					if (d.$) throw new K(10);
					if (16384 !== (d.mode & 61440)) throw new K(54);
				}
				b = {
					type: a,
					Ka: {},
			...
			function Ab(a, b) {
				...
				var d = ub(c, b);
				if (d) throw new K(d);
				if (!c.N.symlink) throw new K(63);
				c.N.symlink(c, b, a);
			}
			function pb(a) {
				a = P(a).node;
				if (!a) throw new K(44);
				if (!a.N.readlink) throw new K(28);
			...
			function T(a, b, c) {
				...
				if (!d && (c = e ? 40960 === (e.mode & 61440) ? 32 : 16384 === (e.mode & 61440) && ("r" !== tb(b) || b & 512) ? 31 : sb(e, tb(b)) : 44)) throw new K(c);
				if (b & 512 && !d) {
					c = e;
					c = "string" == typeof c ? P(c, { ka: !0 }).node : c;
					if (!c.N.T) throw new K(63);
					if (16384 === (c.mode & 61440)) throw new K(31);
					if (32768 !== (c.mode & 61440)) throw new K(28);
					if (d = sb(c, "w")) throw new K(d);
					c.N.T(c, {
						size: 0,
						timestamp: Date.now()
					});
			...
			function Cb(a, b, c) {
				if (null === a.fd) throw new K(8);
				if (!a.seekable || !a.P.Y) throw new K(70);
			...
			function Eb(a) {
				...
				} else if (ArrayBuffer.isView(a)) Db(c, a, 0, a.byteLength, void 0, b.ua);
			...
			var Qb = {
				...
				d: function(a, b, c) {
					...
					try {
						...
						switch (b) {
							...
							case 4: return e = G(), d.flags |= e, 0;
							case 12: return e = G(), sa[e + 0 >> 1] = 2, 0;
							case 13:
							case 14: return 0;
						}
						return -28;
						...
						switch (b) {
							...
							case 21505:
								...
								if (d.tty.V.wa) {
									...
									A[e + 8 >> 2] = 191;
									A[e + 12 >> 2] = 35387;
									for (var f = 0; 32 > f; f++) y[e + f + 17] = a[f] || 0;
								}
								return 0;
							case 21510:
							case 21511:
							...
							case 21508:
								if (!d.tty) return -59;
								if (d.tty.V.xa) for (e = G(), a = [], f = 0; 32 > f; f++) a.push(y[e + f + 17]);
								return 0;
							case 21519:
								if (!d.tty) return -59;
								e = G();
					...
					try {
						a: {
							...
							for (var f, h = b = 0; h < c; h++) {
								...
								a += 8;
								var l = e, p = f, t = y;
								if (0 > r || 0 > p) throw new K(28);
								if (null === l.fd) throw new K(8);
								if (1 === (l.flags & 2097155)) throw new K(8);
								if (16384 === (l.node.mode & 61440)) throw new K(31);
								if (!l.P.read) throw new K(28);
								var S = "undefined" != typeof p;
								if (!S) p = l.position;
								else if (!l.seekable) throw new K(70);
								var ma = l.P.read(l, t, n, r, p);
								S || (l.position += ma);
								var L = ma;
								if (0 > L) {
									var na = -1;
						...
						if ("undefined" == typeof W || "ErrnoError" !== U.name) throw U;
						return U.X;
					}
				},
				...
				i: function(a, b, c, d) {
					try {
						...
						if ("undefined" == typeof W || "ErrnoError" !== t.name) throw t;
						return t.X;
					}
				},
				l: Gb
			...
			g._Highs_call = (a, b, c, d, e, f, h, n, r, l, p, t, S, ma, L, na, U, $b) => (g._Highs_call = Y.I)(a, b, c, d, e, f, h, n, r, l, p, t, S, ma, L, na, U, $b);
			...
			const Yb = g.cwrap("Highs_setIntOptionValue", "number", [
				"number",
				"string",
				"number"
			]), Zb = g.cwrap("Highs_setDoubleOptionValue", "number", [
				"number",
				"string",
				"number"
			]), ac = g.cwrap("Highs_setStringOptionValue", "number", [
				"number",
				"string",
				"string"
			]), bc = g.cwrap("Highs_setBoolOptionValue", "number", [
				"number",
				"string",
				"number"
			]);
			...
			g.solve = function(a, b) {
				...
				for (const d in a) {
					...
					let f;
					if ("number" === b) f = ec;
					else if ("boolean" === b) f = bc;
					else if ("string" === b) f = ac;
			...
			function Z(a) {
				return "inf" === a ? Infinity : "-inf" === a ? -Infinity : +a;
			}
			const gc = {
				Index: (a) => parseInt(a),
				Lower: Z,
			...
			function fc(a) {
				if (3 > q.length) throw Error("Unable to parse solution. Too few lines.");
				let b = ic(q[1], q[2]);
				a = {
					Status: a,
					Columns: {},
				...
				b = ic(q[c + 1], q[c + 2]);
				for (c += 2; "" != q[c]; c++) a.Rows.push(hc(b, q[c]));
...
//#endregion
export default require_highs();

//# sourceMappingURL=highs.js.map